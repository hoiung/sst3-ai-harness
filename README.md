...
Even with the guardrails in place, it was like letting 5 to 10 cowboy agents fire away at the same time. Each one confident. Each one making changes. Each one creating a mess somewhere that took ages to clean up later. I suspect my tradebook still has lingering stale and contradictory code from that era that I haven't yet had the patience to clean up. The cost of multi-agent mess is paid months after the agents have finished their "work", and by then the context of who changed what and why is long gone.
